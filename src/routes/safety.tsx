...
export const Route = createFileRoute("/safety")({
  head: () => ({
    meta: [
      { title: "Safety guide — Peers+Help" },
      { name: "description", content: "Simple habits that keep neighborly borrowing, lending and helping safe on Peers+Help." },
      { property: "og:title", content: "Safety guide — Peers+Help" },
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="mt-3 text-muted-foreground">
          Peers+Help is built on trust between neighbors. These habits keep every exchange smooth, respectful and safe.
        </p>

        <Section title="Before you meet">
          <ul className="list-disc space-y-2 pl-5">
            <li>Chat inside Peers+Help until you feel comfortable — don't share phone or address off-platform before agreeing.</li>
        ...
        <Section title="Meeting in person">
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>Take a photo of the item at pickup and again at return. Peers+Help stores these against the booking.</li>
          </ul>
        </Section>
        ...
        <Section title="Urgent & medical requests">
          <ul className="list-disc space-y-2 pl-5">
            <li>For a true emergency (fire, injury, crime) call your local emergency number first — Peers+Help is a neighborly assist, not an emergency service.</li>
        ...
        <Section title="If something goes wrong">
          <ul className="list-disc space-y-2 pl-5">
            <li>Keep the conversation inside Peers+Help — screenshots and photos help us support you.</li>
        ...
        <div className="mt-12 rounded-2xl border border-dashed border-border bg-muted/40 p-5 text-xs text-muted-foreground">
          Peers+Help is a free community platform. We help neighbors connect — all exchanges happen directly between users.
          Peers+Help is not responsible for any communication, agreement, damage or loss between neighbors.
        </div>
      </main>
      <SiteFooter />
    </div>
