...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: `${SITE_URL}/peers-plus-logo.png?v=20260802` },
      { property: "og:image:secure_url", content: `${SITE_URL}/peers-plus-logo.png?v=20260802` },
      { property: "og:image:type", content: "image/png" },
      { property: "og:image:width", content: "2064" },
      { property: "og:image:height", content: "512" },
      { property: "og:image:alt", content: "Peers Plus logo" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: `${SITE_URL}/peers-plus-logo.png?v=20260802` },
