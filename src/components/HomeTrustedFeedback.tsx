...
export function HomeTrustedFeedback() {
  ...
  return (
    <div className="md:col-span-4" data-reveal data-reveal-delay="220">
      <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-leaf-foreground/70">
        Community feedback and ideas
      </p>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3" data-testid="trusted-feedback-chips">
